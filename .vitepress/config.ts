      ...
      '/sequences/': [
        {
          ...
          items: [
            ...
            { text: '하타-우르드바다누라사나', link: '/sequences/seq6-hatha-urdhva-danurasana' },            { text: '빈야사-아르다찬드라사나', link: '/sequences/seq4-ardha-chandrasana' },            { text: '힐링-우파비스타코나사나', link: '/sequences/seq2-upavistha-konasana' },
